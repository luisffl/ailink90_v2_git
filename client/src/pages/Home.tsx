...
export default function Home() {
  ...
  const [errorType, setErrorType] = useState<
    "processing" | "validation" | "network" | "unknown"
  >("unknown");
  ...
  const {
    isConnected,
    lastMessage,
    webhookStatus: wsWebhookStatus,
  } = useWebSocket(userSessionId);
    ...
    if (response) {
      try {
        ...
        if (validateResponseData(response)) {
          ...
          setErrorMessage(
            "Los datos recibidos están incompletos o no cumplen con los requisitos mínimos",
          );
  ...
  const handleSubmitError = (
    error: any,
    type: "processing" | "validation" | "network" | "unknown" = "unknown",
  ) => {
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Completa este breve cuestionario para recibir un diagnóstico
            personalizado de tu negocio con inteligencia artificial.
          </p>
        </motion.header>
        ...
        {isSubmitted ? (
          ...
          >
            ...
            <motion.div className="w-28 h-28 mx-auto mb-14 mt-8 relative">
              <motion.div
                ...
                <div
                  className={`inline-flex items-center px-3 py-1 text-xs rounded-full ${
                    webhookStatus === "success"
                      ...
                      : webhookStatus === "error" || webhookStatus === "timeout"
