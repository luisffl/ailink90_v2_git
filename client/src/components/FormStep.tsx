    ...
    >
        ...
        <div>
          ...
          <div className="mb-6">
            <Label
              ...
              className="text-sm font-medium mb-2 block text-gray-300"
            >
          ...
          <div className="mb-6">
            <Label
              htmlFor="correo_electronico_usuario"
              className="text-sm font-medium mb-2 block text-gray-300"
            >
            ...
            <Input
              ...
              onChange={(e) =>
                updateFormData("correo_electronico_usuario", e.target.value)
              }
              className="form-control-focus w-full px-4 py-3 rounded-lg"
            />
          ...
          <div className="mb-6">
            <Label
              htmlFor="ciudad_region_usuario"
              className="text-sm font-medium mb-2 block text-gray-300"
            >
              Tu Ciudad o Región Principal{" "}
            ...
            <Input
              ...
              onChange={(e) =>
                updateFormData("ciudad_region_usuario", e.target.value)
              }
              className="form-control-focus w-full px-4 py-3 rounded-lg"
            />
          ...
          <div className="mb-6">
            ...
            >
              ...
              <span className="text-xs text-gray-400 font-normal">
                (Trabajos, estudios, habilidades o actividades en las que tengas
                práctica)
              </span>
            </Label>
            <Textarea
        ...
        <div>
          ...
          <div className="mb-6">
            <Label
              ...
              className="text-sm font-medium mb-2 block text-gray-300"
            >
              ¿Con qué tipo de personas o empresas te interesaría trabajar o
              colaborar? <span className="text-blue-500">*</span>
            </Label>
            <Textarea
              id="tipo_colaboracion"
              value={formData.tipo_colaboracion}
              onChange={(e) =>
                updateFormData("tipo_colaboracion", e.target.value)
              }
      ...
      {step === 4 && (
        <div>
          ...
          <div className="mb-6">
            <Label
              htmlFor="aspectos_mejorar"
              className="text-sm font-medium mb-2 block text-gray-300"
            >
              ¿Qué aspectos te gustaría mejorar o crees que podrían optimizarse
              en el trabajo de ese tipo de personas o empresas?{" "}
              <span className="text-blue-500">*</span>
            </Label>
            <Textarea
              id="aspectos_mejorar"
              ...
              onChange={(e) =>
                updateFormData("aspectos_mejorar", e.target.value)
              }
      ...
      {step === 5 && (
        <div>
          ...
          <div className="mb-6">
            <Label
              htmlFor="ideas_proyectos"
              className="text-sm font-medium mb-2 block text-gray-300"
            >
              ¿Tienes alguna idea, proyecto o solución que se te haya ocurrido
              recientemente, relacionada o no con la inteligencia artificial?{" "}
              <span className="text-blue-500">*</span>
            </Label>
            <Textarea
              id="ideas_proyectos"
              ...
              onChange={(e) =>
                updateFormData("ideas_proyectos", e.target.value)
              }
      ...
      {step === 6 && (
        <div>
          ...
          <div className="mb-6">
            <Label
              htmlFor="comentarios_adicionales"
              className="text-sm font-medium mb-2 block text-gray-300"
            >
            ...
            <Textarea
              ...
              onChange={(e) =>
                updateFormData("comentarios_adicionales", e.target.value)
              }
          ...
          <div className="mb-8">
            <div className="flex items-start space-x-3">
              <input
                ...
                onChange={(e) =>
                  updateFormData("terminos_aceptados", e.target.checked)
                }
              ...
              >
                Acepto que mis datos sean utilizados para generar un diagnóstico
                personalizado y acepto recibir información relevante sobre el
                programa. <span className="text-blue-500">*</span>
              </Label>
            </div>
